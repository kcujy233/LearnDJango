...
def update_pie_chart(request: HttpRequest) -> HttpResponse:
    pages = request.GET.get('pages', 2)  # 默认为1，如果没有提供参数
    pages = int(pages)
    headers = {
    ...
    # return render(request, 'your_template.html', {'qual_chart_path': qual_chart_path, 'page_options': page_options})
